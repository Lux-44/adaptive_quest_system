...
public class QuestManager : MonoBehaviour
{
    ...
    void InitializeQuests()
    {
        ...
        }, new StepInfo(0, new Vector3(-50, 0, -8), "The villager doesn't know you, but if you help them, the village might start trusting you. Making a delivery will earn you an extra reward."), new WorldModelExample(new int[] { -1, 0, 0, 0, 0, 0 }));
        quests.Add(temp);
        ...
        steptemp.GetComponent<MakeDecisionStep>().Description = "The leader of village A is unsure if they should raise the price of corn (option A) or keep it the same (option B). Raising the price would be good for village A, but bad for village B.";
        steptemp.GetComponent<MakeDecisionStep>().ParentSolution = so3;
        steptemp.GetComponent<MakeDecisionStep>().optionTexts = new string[] { "You decided to keep the price low.", "You decided to raise the price." };
        ...
        }, new StepInfo(0, new Vector3(33, 0, -63), "The villager doesn't know you, but if you help them, the village might start trusting you. They are willing to pay you for firewood."), new WorldModelExample(new int[] { 0, -1, 0, 0, 0, 0 })));
        ...
        steptemp2.GetComponent<MakeDecisionStep>().Description = "The leader of village A is outraged and considers attacking village B, you can either take the blame (option A) or just try to talk the leader out of it (option B).";
